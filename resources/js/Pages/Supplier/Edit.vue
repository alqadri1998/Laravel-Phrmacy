...
const form = useForm({
    ...
    status: props.supplier?.status == 1 ? "true" : "false",
});
const submit = () => {
...
<template>
    <Head title="Medicine Supplier Edit" />
    <AuthenticatedLayout>
        <div
        ...
        >
            <form class="space-y-6" @submit.prevent="submit">
                <h5 class="text-xl font-medium text-gray-900 dark:text-white">
                    Edit Medicine Supplier
                    <BackButton :url="route('supplier.index')" />
                </h5>
                <div>
                    <div class="grid grid-cols-2 gap-2">
                        <div>
                            <Label value="Supplier Name" id="name" />
                        ...
                        <div>
                            <Label value="Contact No" id="contact_no" />
